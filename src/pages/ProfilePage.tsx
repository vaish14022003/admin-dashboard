...
//         'Sent message to delivery team at 8:10 AM',
//     ]);
...
//     return (
//         <motion.div
//             className="min-h-screen bg-gradient-to-br from-blue-50 to-purple-100 flex flex-col items-center py-10 px-4"
//             initial={{ opacity: 0 }}
//             animate={{ opacity: 1 }}
//             transition={{ duration: 0.5 }}
//         >
//             <h1 className="text-4xl font-extrabold text-blue-800 mb-8 tracking-wide drop-shadow-md">
//                 Admin Profile
//             </h1>
...
//     useEffect(() => {
//         // Simulate API call
//         axios.get('/api/activity-log').then(res => {
...
//                         className={`px-4 py-2 rounded-lg font-semibold ${activeTab === 'profile' ? 'bg-blue-600 text-white' : 'bg-white text-blue-700'}`}
//                     >
//                         Profile
//                     </button>
//                     <button
//                         onClick={() => setActiveTab('security')}
//                         className={`px-4 py-2 rounded-lg font-semibold ${activeTab === 'security' ? 'bg-blue-600 text-white' : 'bg-white text-blue-700'}`}
//                     >
//                         Security
//                     </button>
//                     <button
//                         onClick={() => setActiveTab('billing')}
//                         className={`px-4 py-2 rounded-lg font-semibold ${activeTab === 'billing' ? 'bg-blue-600 text-white' : 'bg-white text-blue-700'}`}
//                     >
//                         Billing
//                     </button>
//                 </div>
...
//                         <p className="text-gray-600 text-sm">Password updates, 2FA setup, and login devices (coming soon...)</p>
//                     </div>
//                 )}
...
//                         <p className="text-gray-600 text-sm">No billing info available. Premium plan not activated.</p>
//                     </div>
//                 )}
//             </motion.div>
//         </div>
